                    ...
                    {cart.map((item) => (
                      <tr className="table-body-row" key={item.id}>
                        <td className="product-remove">
                          <button onClick={() => removeFromCart(item.id)} style={{border: 'none', background: 'transparent', cursor: 'pointer'}}>
                            <i className="far fa-window-close"></i>
                          </button>
                        </td>
                        <td className="product-image"><img src={`/assets/img/heritage/${item.image}`} alt={item.name} /></td>
